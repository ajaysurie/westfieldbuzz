...
export const EVENT_SOURCES: EventSourcePolicy[] = [
  ...
  {
    ...STANDARD_FETCH,
    id: "rialto-squarespace",
    name: "Rialto Center for Creativity",
    type: "squarespace-json",
    url: "https://www.rialtowestfield.org/events?format=json",
    publicUrl: "https://www.rialtowestfield.org/events",
    town: "Westfield",
    autoApprove: false,
    group: "nearby-venues",
    allowedHosts: ["www.rialtowestfield.org", "rialtowestfield.org"],
    expectedContentTypes: ["application/json", "text/json"],
    expectedLayoutMarker: "collection",
  },
  {
    ...STANDARD_FETCH,
    id: "westfield-historical-squarespace",
    name: "Westfield Historical Society",
    type: "squarespace-json",
    url: "https://www.westfieldhistoricalsociety.org/events?format=json",
    publicUrl: "https://www.westfieldhistoricalsociety.org/events",
    town: "Westfield",
    autoApprove: false,
    group: "nearby-venues",
    allowedHosts: [
